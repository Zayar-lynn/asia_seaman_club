            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form id="insert_adminpost" enctype="multipart/form-data" class="md-form">
                              {{csrf_field()}}
...
//                "ordering": false,
           ...
           delete_data=function(id){
            ...
            $('#insert_adminpost').on('submit',function (e)
            {
                e.preventDefault();
                ...
                ({
                    type: "POST",
                    url: "{{url('upload_admin_post_photo')}}",
                    data:alldata,
                    cache:false,
                    processData: false,
                    contentType: false,
