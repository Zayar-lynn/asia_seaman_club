  ...
  <div class="container"> 
    ...
    <div class="row">
      ...
      <div class="col-md-8"> 
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="row our-teacher">
              <div class="col-md-4">
                {{-- <img src="{{asset('img/client2.jpg')}}" alt="" class="img-responsive"> --}}
              </div>
              <div class="col-md-8">
                <h4>
                  Teacher
          ...
          <div class="col-md-5">
            <div class="row">
              <div class="col-md-4">
                 <h4>Price {{$course_detail->price}}</h4>
              </div>
              <div class="col-md-8">
                <a href="checkout.php" class="btn btn-danger btn-lg buy-now">Buy Now</a>
              </div>
            </div>
          </div>
        </div>
        <div class="blogWraper blogdetail">
          <ul class="blogList">
            <li>
              <div class="postimg">
                <img src="{{$course_detail->photo_url}}" alt="Blog Title">
                <div class="date"> 17 SEP</div>
              </div>
              <div class="post-header margin-top30">
                <h4>{{$course_detail->title}}</h4>
                <div class="postmeta">Category : <span>
                @foreach($course_detail->course_categories as $data)
                  ({{$data->category_name}})
                @endforeach
                </span></div>
              </div>
