        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{url('update/training/company_photo')}}" id="update_data" enctype="multipart/form-data" class="" method="POST">
                        {{csrf_field()}}
                        <input type="hidden" name="type" id="type">
                        <input type="hidden" name="project_id" id="project_id">
                        <div class="modal-body">
                           <img id="image" style="height: 180px;width:200px;" class="card-img-top light_box_img" src="" alt="Card image cap">
                           <div class="card-body">
        ...
        $(document).ready(function() {
            show_edit_model=function(id){
                //if insert
                    ...
                    $.ajax({
                        type: 'post',
//                        url: '../company/training/photo_detail/'+id,
