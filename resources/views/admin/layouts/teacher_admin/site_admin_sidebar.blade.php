    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            {{-- <li class="nav-item @if($url=="company_profile") active @endif">
                <a class="nav-link" href="{{url('teacher_dashboard/company_profile')}}">
                    <i class="material-icons">person</i>
                    <p>Manage Website</p>
                </a>
            </li>
            <li class="nav-item @if($url=="company_list") active @endif">
                <a class="nav-link" href="{{url('teacher_dashboard/company_list')}}">
                    <i class="material-icons">content_paste</i>
                    <p>Company List</p>
                </a>
            </li>
            <li class="nav-item @if($url=="category") active @endif">
                <a class="nav-link" href="{{url('teacher_dashboard/category')}}">
                    <i class="material-icons">library_books</i>
                    <p>Manage Category</p>
                </a>
            </li>
            <li class="nav-item @if($url=="blog") active @endif">
                <a class="nav-link" href="{{url('teacher_dashboard/blog')}}">
                    <i class="material-icons">bubble_chart</i>
                    <p>Manage Blog</p>
                </a>
            </li>
            <li class="nav-item @if($url=="feedback") active @endif">
                <a class="nav-link" href="{{url('teacher_dashboard/feedback')}}">
                    <i class="material-icons">location_ons</i>
                    <p>Manage Feedback</p>
                </a>
            </li> --}}
            <li class="nav-item @if($url=="course") active @endif">
                <a class="nav-link" href="{{url('teacher_dashboard/course')}}">
                    <i class="material-icons">content_paste</i>
                    <p>Course</p>
                </a>
            </li>
